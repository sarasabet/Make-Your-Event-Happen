...
const functionRuntimeContributorFactory = context => {
    return {
        contribute: async (request) => {
            ...
            return {
                runtime: {
                    ...
                    layerExecutablePath: path_1.default.join('nodejs', 'node_modules'),
                    layerDefaultFiles: [
                        {
                            path: 'nodejs',
        ...
        package: params => legacyPackage_1.packageResource(params, context),
        build: legacyBuild_1.buildResource,
        invoke: async (params) => invoke_1.invoke({
