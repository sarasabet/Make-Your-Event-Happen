...
function cfnSub(valNode, { params, conditions, resources, exports }, processValue) {
    ...
    if (!lodash_1.isPlainObject(subs)) {
...
function cfnGetAtt(valNode, { resources }, processValue) {
    if (!Array.isArray(valNode) && valNode.length !== 2) {
...
function cfnImportValue(valNode, { params, conditions, resources, exports }, processValue) {
    var _a;
    if (!(lodash_1.isPlainObject(valNode) || typeof valNode === 'string')) {
    ...
    return (_a = exports[key]) !== null && _a !== void 0 ? _a : import_model_table_resolver_1.importModelTableResolver(key, params.env);
}
exports.cfnImportValue = cfnImportValue;
function cfnCondition(valNode, { conditions }, processValue) {
    if (typeof valNode !== 'string') {
