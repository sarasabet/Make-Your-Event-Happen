...
exports.processCloudFormationStack = exports.processOutputs = exports.processResources = exports.filterResourcesBasedOnConditions = exports.sortResources = exports.getDependencyResources = exports.processConditions = exports.mergeParameters = exports.nestedStackHandler = exports.CFN_PSEUDO_PARAMS = void 0;
...
function nestedStackHandler(resourceName, resource, cfnContext, cfnTemplateFetcher) {
    ...
    const processedParameters = Object.entries(parameters).reduce((acc, [parameterName, parameterValue]) => {
        return {
            ...acc,
            [parameterName]: field_parser_1.parseValue(parameterValue, cfnContext),
        };
    }, {});
