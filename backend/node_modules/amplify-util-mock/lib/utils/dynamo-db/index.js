...
async function createAndUpdateTable(dynamoDbClient, config) {
    ...
    const existingTablesWithDetails = await utils_1.describeTables(dynamoDbClient, existingTables.TableNames);
    ...
    await utils_1.createTables(dynamoDbClient, tablesToCreate);
    ...
    await utils_1.updateTables(dynamoDbClient, updateTableInputs);
}
