    ...
    constructor(context) {
        this.createArtifacts = async (request) => {
            ...
            if (!fs_extra_1.default.existsSync(stacksDirectoryPath)) {
                ...
                fs_extra_1.default.copyFileSync(path_1.default.join(aws_constants_1.rootAssetDir, 'resolver-readme', 'RESOLVER_README.md'), path_1.default.join(resolverDirectoryPath, 'README.md'));
            }
