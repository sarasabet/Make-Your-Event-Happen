...
async function configure(context, defaultValuesFilename, serviceMetadata, resourceName) {
    ...
    print.info('https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.CoreComponents.html#HowItWorks.CoreComponents.PrimaryKey');
    print.info('');
    answers.KeySchema = [];
    ...
    print.info('https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.CoreComponents.html#HowItWorks.CoreComponents.SecondaryIndexes');
    print.info('');
    ...
    answers.AttributeDefinitions = answers.AttributeDefinitions.filter(attributeDefinition => usedAttributeDefinitions.indexOf(attributeDefinition.AttributeName) !== -1);
