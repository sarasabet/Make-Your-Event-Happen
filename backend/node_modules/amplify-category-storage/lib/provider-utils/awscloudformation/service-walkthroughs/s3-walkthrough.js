...
const addWalkthrough = async (context, defaultValuesFilename, serviceMetadata, options) => {
    while (!exports.checkIfAuthExists(context)) {
    ...
    const resourceName = exports.resourceAlreadyExists(context);
    if (resourceName) {
...
const updateWalkthrough = (context, defaultValuesFilename, serviceMetada) => {
...
const migrate = (context, projectPath, resourceName) => {
