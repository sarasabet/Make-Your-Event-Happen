...
async function generateNestedAuthTriggerTemplate(context, category, request) {
...
async function createCustomResourceforAuthTrigger(context, authTriggerConnections) {
