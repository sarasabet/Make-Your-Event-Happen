...
export declare const getUpdateAuthRequestAdaptor: (projectType: string, requiredAttributes: string[]) => ({ serviceModification, }: UpdateAuthRequest) => ServiceQuestionsResult;
