...
const mutableIdentityPoolMap = (projectType, idPoolConfig) => {
    ...
    const result = {
        ...
        authProviders: (idPoolConfig.identitySocialFederation || [])
            ...
            .map(ap => ap.value),
        ...((idPoolConfig === null || idPoolConfig === void 0 ? void 0 : idPoolConfig.identitySocialFederation) || []).reduce((acc, it) => lodash_1.merge(acc, { [socialFederationKeyMap(it.provider, projectType)]: it.clientId }), {}),
    };
