...
class ResourceFactory {
    constructor() {
        this.addDefaultConditionExpression = (operation) => {
            const attributeCheck = operation === 'create' ? 'attribute_not_exists' : 'attribute_exists';
            return graphql_mapping_template_1.ifElse(graphql_mapping_template_1.ref(graphql_transformer_common_1.ResourceConstants.SNIPPETS.ModelObjectKey), graphql_mapping_template_1.compoundExpression([
                ...
                graphql_mapping_template_1.forEach(graphql_mapping_template_1.ref('entry'), graphql_mapping_template_1.ref(`${graphql_transformer_common_1.ResourceConstants.SNIPPETS.ModelObjectKey}.entrySet()`), [
                    graphql_mapping_template_1.ifElse(graphql_mapping_template_1.raw('$velocityCount == 1'), graphql_mapping_template_1.qref(`$condition.put("expression", "${attributeCheck}(#keyCondition$velocityCount)")`), graphql_mapping_template_1.qref('$condition.put(' + `"expression", "$condition.expression AND ${attributeCheck}(#keyCondition$velocityCount)")`)),
                    graphql_mapping_template_1.qref('$condition.expressionNames.put("#keyCondition$velocityCount", "$entry.key")'),
                ]),
            ]), graphql_mapping_template_1.set(graphql_mapping_template_1.ref('condition'), graphql_mapping_template_1.obj({
                expression: graphql_mapping_template_1.str(`${attributeCheck}(#id)`),
                expressionNames: graphql_mapping_template_1.obj({
