        ...
        case 'kinesis':
            ...
            switch (streamKind) {
                ...
                case 'analyticsKinesisStream':
                    return await analyticsWalkthrough_1.askAnalyticsCategoryKinesisQuestions(context);
                default:
                    return {};
            }
        case 'dynamoDB':
            ...
            switch (streamKind) {
                ...
                case 'graphqlModelTable':
                    return await dynamoDBWalkthrough_1.askAPICategoryDynamoDBQuestions(context);
                case 'storageDynamoDBTable':
                    ...
                    dynamoDBCategoryStorageRes = await dynamoDBWalkthrough_1.askDynamoDBQuestions(context, true);
