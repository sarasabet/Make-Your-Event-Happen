...
const run = async (context) => {
    ...
    const confirmContinue = !!resourceName || ((_d = (_c = context.input) === null || _c === void 0 ? void 0 : _c.options) === null || _d === void 0 ? void 0 : _d.yes) ||
    ...
    try {
        ...
        for await (const resource of resourcesToBuild) {
            resource.lastBuildTimeStamp = await buildFunction_1.buildFunction(context, resource);
            await package_1.packageResource(context, resource);
        }
    }
    catch (err) {
...
const getSelectedResources = async (context, resourceName) => {
    return (await context.amplify.getResourceStatus(constants_1.category, resourceName)).allResources;
};
