            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        (_b = requestMappingTemplate.render({ source: source, arguments: args, stash: stash }, context, info), result = _b.result, stash = _b.stash, templateErrors = _b.errors, isReturn = _b.isReturn, hadException = _b.hadException);
                        context.appsyncErrors = __spreadArrays(context.appsyncErrors, (templateErrors || []));
                    ...
                    case 2:
                        (_c = _e.sent(), prevResult = _c.result, stash = _c.stash, hadException = _c.hadException);
