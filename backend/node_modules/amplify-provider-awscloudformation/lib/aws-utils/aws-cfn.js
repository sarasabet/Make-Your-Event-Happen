...
class CloudFormation {
    ...
    async updateamplifyMetaFileWithStackOutputs(parentStackName) {
        ...
        const resources = result.StackResources.filter(resource => ![
            'DeploymentBucket',
            'AuthRole',
            'UnauthRole',
                ...
                Object.keys(amplifyMeta[category]).forEach(resource => {
                    ...
                    if (index !== -1) {
                        ...
                        if (amplifyMeta[category][resource]) {
                            ...
                            if (resourceObject.service === 'AppSync' &&
    ...
    deleteResourceStack(envName) {
        ...
        return new Promise((resolve, reject) => {
            ...
            cfnModel.describeStacks(cfnStackParams, (err, data) => {
                ...
                if ((err && err.statusCode === 400 && err.message.includes(`${stackName} does not exist`)) ||
...
//# sourceMappingURL=aws-cfn.js.map