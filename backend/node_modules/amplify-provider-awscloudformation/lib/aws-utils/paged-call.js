...
const pagedAWSCall = async (action, params, accessor, getNextToken) => {
    assert_1.default(action, 'missing argument: action');
    assert_1.default(accessor, 'missing argument: accessor');
    assert_1.default(getNextToken, 'missing argument getNextToken');
    let result = [];
    let response;
