...
async function run(context) {
    ...
    if (inputParams.amplify && inputParams.amplify.appId) {
        ...
        try {
            ...
            log(e);
            context.print.error(`Amplify AppID: ${amplifyAppId} not found. Please ensure your local profile matches the AWS account or region in which the Amplify app exists.`);
