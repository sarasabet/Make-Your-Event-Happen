...
function cacheRoleCredentials(roleArn, sessionName, credentials) {
    let cacheContents = {};
...
function getCachedRoleCredentials(roleArn, sessionName) {
    let roleCredentials;
    const cacheFilePath = getCacheFilePath();
    if (fs.existsSync(cacheFilePath)) {
        try {
...
function validateCredentials(credentials, profileName) {
    const missingKeys = [];
    if ((credentials === null || credentials === void 0 ? void 0 : credentials.source_profile) && (credentials === null || credentials === void 0 ? void 0 : credentials.role_arn)) {
        return;
    }
    if (!(credentials === null || credentials === void 0 ? void 0 : credentials.accessKeyId)) {
        missingKeys.push('aws_access_key_id');
    }
    if (!(credentials === null || credentials === void 0 ? void 0 : credentials.secretAccessKey)) {
