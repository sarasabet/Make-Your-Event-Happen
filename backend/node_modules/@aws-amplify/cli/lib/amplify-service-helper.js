...
const postPullCodegen = async (context) => {
    ...
    const gqlApiName = (_c = lodash_1.default.entries(meta === null || meta === void 0 ? void 0 : meta.api).find(([_, value]) => value.service === 'AppSync')) === null || _c === void 0 ? void 0 : _c[0];
    if (!gqlApiName) {
        return;
    }
    if (await graphql_transformer_core_1.isDataStoreEnabled(path.join(amplify_cli_core_1.pathManager.getBackendDirPath(), 'api', gqlApiName))) {
