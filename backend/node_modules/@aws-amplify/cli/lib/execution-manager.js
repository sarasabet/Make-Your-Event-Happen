...
async function raisePreCodegenModelsEvent(context) {
    await raiseEvent(context, new amplify_event_1.AmplifyEventArgs(amplify_event_1.AmplifyEvent.PreCodegenModels, new amplify_event_1.AmplifyPreCodegenModelsEventData()));
}
...
async function raisePostCodegenModelsEvent(context) {
    await raiseEvent(context, new amplify_event_1.AmplifyEventArgs(amplify_event_1.AmplifyEvent.PostCodegenModels, new amplify_event_1.AmplifyPostCodegenModelsEventData()));
}
