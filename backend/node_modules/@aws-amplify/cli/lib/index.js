    ...
    try {
        ...
        if (error.name === 'JSONValidationError') {
            ...
            if (((_b = jsonError.unknownFlags) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                ...
                context_extensions_1.print.error(`These feature flags are defined in the "amplify/cli.json" configuration file and are unknown to the currently running Amplify CLI:`);
            ...
            if (printSummary) {
                context_extensions_1.print.error('');
                context_extensions_1.print.error(`This issue likely happens when the project has been pushed with a newer version of Amplify CLI, try updating to a newer version.`);
                if (ci_info_1.isCI) {
                    context_extensions_1.print.error('');
