...
export declare function updateAwsMetaFile(filePath: string, category: string, resourceName: string, attribute: $TSAny, value: $TSAny, timestamp: $TSAny): $TSMeta;
export declare function updateamplifyMetaAfterResourceAdd(category: string, resourceName: string, metadataResource?: {
    dependsOn?: any;
}, backendConfigResource?: {
    dependsOn?: any;
}, overwriteObjectIfExists?: boolean): void;
export declare function updateProvideramplifyMeta(providerName: string, options: $TSObject): void;
export declare function updateamplifyMetaAfterResourceUpdate(category: string, resourceName: string, attribute: string, value: $TSAny): $TSMeta;
