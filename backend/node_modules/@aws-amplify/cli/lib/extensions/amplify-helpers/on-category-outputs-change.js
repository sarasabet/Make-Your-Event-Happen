...
async function onCategoryOutputsChange(context, cloudAmplifyMeta, localMeta) {
    ...
    if (projectConfig.frontend) {
        ...
        await frontendHandlerModule.createFrontendConfigs(context, get_resource_outputs_1.getResourceOutputs(localMeta), get_resource_outputs_1.getResourceOutputs(cloudAmplifyMeta));
    }
