...
async function getConfirmation(context, env) {
    ...
    return {
        proceed: await context.amplify.confirmPrompt(chalk_1.default.red(`Are you sure you want to continue? This CANNOT be undone. (This will delete ${environmentText} of the project from the cloud${env ? '' : ' and wipe out all the local files created by Amplify CLI'})`), false),
        deleteS3: true,
