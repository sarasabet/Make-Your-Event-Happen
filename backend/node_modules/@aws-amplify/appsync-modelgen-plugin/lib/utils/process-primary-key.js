...
exports.processPrimaryKey = (model) => {
    var _a;
    ...
    const primaryKeyField = model.fields.find(field => fieldUtils_1.getDirective(field)('primaryKey'));
    if (!primaryKeyField) {
        return;
    }
    const primaryKeyDirective = fieldUtils_1.getDirective(primaryKeyField)('primaryKey');
