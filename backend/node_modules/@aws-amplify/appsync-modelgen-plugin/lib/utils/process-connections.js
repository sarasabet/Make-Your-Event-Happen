...
exports.processConnections = exports.getConnectedField = exports.flattenFieldDirectives = exports.makeConnectionAttributeName = exports.DEFAULT_HASH_KEY_FIELD = exports.CodeGenConnectionType = void 0;
...
function getConnectedField(field, model, connectedModel) {
    const connectionInfo = fieldUtils_1.getDirective(field)('connection');
    if (!connectionInfo) {
